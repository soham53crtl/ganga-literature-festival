...
export default function FloatingSocialRail() {
  return (
    <div className="pointer-events-none fixed right-4 top-1/2 z-[65] hidden -translate-y-1/2 lg:flex lg:right-6 xl:right-8">
      <div className="pointer-events-auto flex flex-col items-center gap-4">
        {socials.map((social) => (
          <a
            ...
            className="group flex h-12 w-12 items-center justify-center rounded-full border border-[#b58b32] bg-black text-[#d6ad43] shadow-[0_14px_40px_rgba(0,0,0,0.28)] backdrop-blur-md transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#b58b32] hover:text-white"
          >
            {social.icon}
          </a>
        ))}
